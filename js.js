...
// =======================
// FONCTION DOWNLOAD COMME LES AUTRES BOUTONS
// =======================
...
// =======================
// TP2 - Fonctions (EXACTEMENT COMME LES AUTRES)
// =======================
...
function downloadTP2Video() { downloadDirect(FILE_URLS_TP2.VIDEO, 'room.mp4'); }
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    console.log('🚀 Portfolio chargé — Tous les boutons identiques');
});
